      ...
      <section className="bg-[#1A0F00] flex items-center p-6 md:p-20">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
          ...
          <div className="space-y-6 ">
            <p className="text-4xl md:text-5xl italic font-serif text-[#C8A27A] ">About Us</p>
              ...
              >
                ...
                <div className="flex items-start gap-6">
                      ...
                      <div className="absolute bottom-[8px] left-1/2 transform -translate-x-1/2 w-[90%] h-[85%] rounded-b-xl overflow-hidden" 
                        ...
                        >
                          ...
                          <div className="absolute inset-0 opacity-60">
                            ...
                            <div className="absolute w-1 h-1 bg-white rounded-full top-[70%] left-[40%] animate-bubble-1" style={{ animationDelay: "1.5s" }}></div>
                            <div className="absolute w-1 h-1 bg-white rounded-full top-[60%] left-[60%] animate-bubble-2" style={{ animationDelay: "0.8s" }}></div>
                            <div className="absolute w-0.5 h-0.5 bg-white rounded-full top-[80%] left-[80%] animate-bubble-3" style={{ animationDelay: "1.2s" }}></div>
                          </div>
                  ...
                  <div className="flex flex-col">
                    <h3 className="text-[#C8A27A] text-xl font-medium mb-1">Proudly Serving</h3>
                    <div className="flex items-baseline gap-3">
                      <span className="text-5xl md:text-7xl font-serif text-[#C8A27A] font-bold tracking-tighter tabular-nums relative">
                        {beerCount}
                        <span className="absolute -right-6 text-3xl md:text-5xl">+</span>
                      </span>
                    </div>
